...
- (void)perform:(NSString *)command {
    ...
    if ([cmd isEqualToString:@"LEFT"]) {
        ...
        NSLog(@"Hello block");
        [self.roboMe sendCommand:kRobot_HeadTiltDown];
        [self play:@"Yes. Ofcourse you are my master"];
    }
...
//        NSData *welcomeData = [message dataUsingEncoding:NSUTF8StringEncoding];
    ...
    else if ([cmd rangeOfString:@"I AM GOING TO "].location != NSNotFound){
        NSString *locationString =cmd;
    ...
    else if ([cmd isEqualToString:@"I AM NOT FEELING WELL"]){
        
        
        NSLog(@"Sending the health reports to guardian");
        ...
        NSLog(@"Name");
        [self play:@"My Name is Assistnat-De-sante"];
        //[self.commandPlayer playCommand:@"GooDAfternoon.mp3"];
    }
    ...
    ////Recommendation*************************************************************************************
        ...
        [self play:@"What is your age?"];
    }
    else if([cmd isEqualToString:@"MY AGE IS 25"]){
        [self play:@"What is your gender?"];
        ...
        [self play:@"I recommend following diet: 1 cup of fruits, 2 cups of vegetables, 1 cup dairy, 3 ounces dairy, 15 grams oil"];
    ...
    //parse
        ...
        [self play:@"you had 299 calories today"];
    }
    ...
    //***************************************SENTIMENT**************************************************
        ...
        [self play:@"That is positive maintain that"];
        NSLog(@"positve");
    }
...
-(void) sendMessageWeather{
    ...
    [manager GET:urlString parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSString *messageBody = @"Hi Gurdian, my master is not feeling well. Please take necessary precautions";
